...
//  This file contains two versions of how users are displayed

//  1. Select List version
//  2. Input field with a suggested list version

//////////////////////////////////////////////////////

// 1. Select List version

// <select><option value="ukey">User</option></select>

// NOTE: A suggested list box cannot be added to a select component as one cannot type

//////////////////////////////////////////////////////

// document.addEventListener('DOMContentLoaded', function () {
//   console.log(`Inside switchable.js.  Portal is: ${portal}.  Ukey is: ${ukey}`);
...
//   const userJSONfile = `https://dev.countingopinions.com/ws/portal/get_users.php?is_menu&portal=${portal}&ukey=${ukey}&showOrgs`;
...
//   // Select dropdown instead of input + datalist
//   const userSelect = document.createElement('select');
//   userSelect.id = 'userSelect';
//   userSelect.className = 'users-select';
...
//   inputContainer.appendChild(userSelect);
...
//     const typedValue = userSelect.value;
//     const match = userData.find((u) => u.ukey === typedValue);
...
//       if (!originalUKey) {
//         originalUKey = ukey; // current ukey becomes the original
...
//   // ie.  in menu.js within handleLinkClick(e) function this is how showModal function is called
...
function impersonationBanner() {
  ...
  if (originalUkey !== null && originalUkey !== currentUKey) {
    ...
    banner.innerHTML = `
      <p>
          You are currently viewing the portal as user: <strong>${user}</strong>.
