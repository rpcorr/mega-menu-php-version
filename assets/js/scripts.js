...
$(document).ready(function () {
  ...
  document.getElementById('menu-more').offsetWidth;
  ...
  document
    ...
    .addEventListener('click', function (event) {
      ...
      if (
        this.closest('.menu-item-has-children').classList.contains('visible')
      ) {
        ...
        this.setAttribute('aria-label', 'Click Enter to close More sub menu');
        ...
        // update More aria-label to open menu
        this.setAttribute(
          'aria-label',
          'More has a sub menu. Click enter to open'
        );
...
function closeAllMenus(menuItem) {
  ...
  document
    ...
    .forEach(function (element) {
      ...
      // Reset aria-expanded attribute to false
      element.setAttribute('aria-expanded', 'false');
    });
